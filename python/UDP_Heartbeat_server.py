...
while True:     
	...
	try:
		...
		# Note: the 'address' in serverSocket.sendto is NOT server's (servername,serverPort)
		# it is the client address : the port server spawn in child process
		#serverSocket.sendto('hello client UDP'.encode(),(servername,serverPort))
		serverSocket.sendto('hello client UDP'.encode(),address)
		print('[Hey client address]',address)
